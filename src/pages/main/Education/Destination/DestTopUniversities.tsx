        ...
        {universities.map((u, i) => (
          <div key={i} className="relative">
            ...
            <motion.a
              ...
              className={`
                group bg-card border rounded-sm h-36 px-6 pt-6 pb-3 flex flex-col items-center justify-center text-center shadow-sm hover:shadow-xl transition duration-300 cursor-pointer ${activeIndex === i ? "border-primary shadow-lg ring-2 ring-primary/40" : "border-border"}
              `}
            >
              {/* Logo Container */}
