        ...
        >
          {faq.faqDetail.map((faqItem, index) => (
            <motion.div
              ...
              variants={itemVariants}
              custom={index}
              className="border border-gray-200 dark:border-gray-700 rounded-sm overflow-hidden bg-white dark:bg-gray-800 shadow-sm hover:shadow-md transition-shadow"
            >
              <motion.button
