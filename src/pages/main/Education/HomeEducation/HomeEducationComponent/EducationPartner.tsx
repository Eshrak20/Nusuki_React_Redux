...
const EducationPartner = () => {
  ...
  return (
    <section className="pt-2 lg:pt-20 pb-16 lg:pb-32 px-6">
      <div className="max-w-7xl mx-auto">
        {/* Section Header */}
        <div className="-mb-6 lg:-mb-10 text-center">
          <EduTitle name="Our Education Partners" />
        </div>
        <p className="hidden lg:block text-muted-foreground mb-16 text-center text-lg">
  ...
  {partners.map((partner, index) => (
    <div
      ...
      className="
        ...
        w-full sm:w-[calc(50%-1.5rem)] md:w-[calc(33.333%-1.5rem)] lg:w-[calc(25%-1.5rem)]
        max-h-50
      "
    >
      <img
