        ...
        {itineraries.map((item) => (
          ...
          >
            ...
            <CardContent className="p-5 flex flex-col grow">
              ...
              {/* Location Button */}
              <button className="hidden items-center justify-center gap-2 w-fit bg-hajj text-white px-5 py-2.5 rounded-sm text-sm font-semibold hover:opacity-90 transition-all shadow-sm active:scale-95">
