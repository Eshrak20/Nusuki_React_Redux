    ...
    return (
        ...
        >
            ...
            <div className="absolute inset-0 z-20 pointer-events-none">
                ...
                <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-gold-600/10 rounded-full blur-[120px] animate-pulse delay-1000"
                    style={{ backgroundColor: 'rgba(212, 175, 55, 0.05)' }}></div>
            </div>
