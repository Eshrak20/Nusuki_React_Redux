...
const UmrahDetPackageSighting = ({
  ...
  return (
    <div className="mx-8 lg:mx-24 space-y-8 mb-12 lg:mb-20 bg-background text-foreground p-6 rounded-sm border border-border/50">
      {/* Title */}
...
export default UmrahDetPackageSighting;