...
const UmrahDetPackageServices = ({
  services,
}: HajjUmDetPackageServicesProps) => {
  return (
    <div className="w-full mx-8 lg:mx-24 space-y-8 -mb-8 lg:mb-20 bg-background text-foreground p-6 rounded-lg border border-border/50">
      {/* Title */}
...
export default UmrahDetPackageServices;