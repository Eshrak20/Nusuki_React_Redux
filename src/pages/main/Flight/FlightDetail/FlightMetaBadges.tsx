...
const badgeClass =
  "inline-flex items-center gap-2 rounded-sm lg:rounded-full border border-border bg-background px-2.5 lg:px-3 py-2 text-[9.7px] lg:text-sm font-medium text-muted-foreground shadow-sm transition-colors hover:bg-muted/50";
  ...
  return (
    <div className="flex lg:flex-wrap gap-2 lg:gap-3">
      ...
      <span className={badgeClass}>
        ...
        <span className="inline">{flight.fare.refundable ? "Refundable" : "Non-Refundable"}</span>
