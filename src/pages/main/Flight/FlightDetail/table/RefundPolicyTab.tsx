  ...
  return (
    <div className="overflow-hidden rounded-sm border border-border bg-card shadow-sm">
      ...
      <div className="space-y-4 px-4 py-4 text-sm">
        <div className="flex gap-3 rounded-sm border bg-background p-4">
        ...
        <div className="flex gap-3 rounded-sm border border-yellow-200 bg-yellow-50 p-4 dark:border-yellow-500/20 dark:bg-yellow-500/10">
