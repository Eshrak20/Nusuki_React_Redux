      ...
      <div className="container relative z-10 mx-auto px-4 text-center">
        ...
        <div className="flex flex-col items-center justify-center gap-4 lg:pb-7 sm:flex-row sm:gap-6">
          ...
          <a
            ...
            className="h-14 flex items-center justify-center w-full rounded-full bg-primary-foreground px-10 text-base font-semibold text-primary shadow-lg hover:bg-primary-foreground/90 sm:w-auto transition-all active:scale-95"
          >
