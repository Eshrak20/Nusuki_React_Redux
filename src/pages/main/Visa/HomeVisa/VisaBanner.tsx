...
const VisaBanner = () => {
      ...
      >
        <div className="flex flex-col items-center text-center">
          ...
          <motion.div variants={fadeInUp}>
            <Badge
              variant="secondary"
              className="mb-3 border-none dark:bg-primary bg-primary-foreground/10 px-4 py-1.5 text-primary-foreground dark:text-foreground backdrop-blur-md"
            >
          ...
          <motion.h1
            variants={fadeInUp}
            className="mb-6 text-4xl font-bold tracking-tight text-white dark:text-foreground lg:text-6xl"
          >
            Visa Services
          </motion.h1>
          ...
          <motion.p
            variants={fadeInUp}
            className="mb-10 max-w-2xl text-lg text-primary-foreground/80 dark:text-foreground lg:text-xl"
          >
  ...
  placeholder="Search by country name..."
                className="h-12 w-full rounded-full border-none bg-background/95 px-8 pr-1
text-foreground
placeholder:text-muted-foreground
dark:placeholder:text-foreground
shadow-2xl backdrop-blur-sm ring-1 ring-white transition-all
focus-visible:ring-2 focus-visible:ring-foreground lg:h-14"
              />
              <Button
