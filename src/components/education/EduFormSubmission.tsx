                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="relative">
                      <div
                        className={`group flex items-center border-b transition-all duration-300 ${
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="relative mt-2">
                    <div
                      className={`group flex items-start border-b transition-all duration-300 ${
                    ...
                    >
                      <MessageSquare
                        size={16}
                        className={`mr-3 mt-2 transition-colors ${
                          focusedField === "description"
                            ? "text-primary"
                            : "text-muted-foreground"
                        }`}
