          ...
          >
            ...
            <div className="relative z-10 px-5 py-6 sm:px-8 sm:py-8">
              <div className="flex flex-col items-center text-center">
                <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-sm bg-red-50 shadow-sm dark:bg-red-500/10">
                ...
                <div className="mt-6 w-full max-w-sm">
                  <Button
                    ...
                    className="group h-12 w-full rounded-sm bg-primary text-base font-semibold shadow-lg transition-all duration-200 hover:scale-[1.02]"
                  >
                    {isRateLimit ? (
                      <>
