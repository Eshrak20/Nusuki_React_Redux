    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <div className="mt-6 flex w-full max-w-md flex-col gap-3 sm:flex-row">
          <Link
            to="/"
            className="group flex h-12 flex-1 py-3 md:py-0 items-center justify-center rounded-sm bg-primary px-4 text-base font-semibold text-white shadow-lg transition-all duration-200 hover:scale-[1.02] dark:text-black"
          >
          ...
          <button
            ...
            className="group flex h-12 flex-1 items-center py-3 md:py-0 justify-center rounded-sm border border-slate-300 bg-white px-4 text-base font-semibold text-slate-700 shadow-sm transition-all duration-200 hover:scale-[1.02] hover:border-primary hover:text-primary dark:border-slate-700 dark:bg-slate-900 dark:text-slate-200 dark:hover:border-sky-500 dark:hover:text-sky-400"
          >
