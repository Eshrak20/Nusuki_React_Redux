      ...
      <div className="px-1">
        <div className="rounded-2xl border border-border/60 bg-muted/20 p-4 sm:p-5">
          ...
          <div className="mt-5 grid grid-cols-2 gap-3">
            {/* Min Price Card */}
            <div className="rounded-2xl border bg-background px-3 py-3 shadow-sm space-y-2">
              <Skeleton className="h-3 w-12" /> {/* Label */}
              <Skeleton className="h-5 w-20" /> {/* Price */}
            </div>

            {/* Max Price Card */}
            <div className="rounded-2xl border bg-background px-3 py-3 shadow-sm space-y-2 flex flex-col items-end">
              <Skeleton className="h-3 w-12" /> {/* Label */}
              <Skeleton className="h-5 w-20" /> {/* Price */}
            </div>
          </div>
