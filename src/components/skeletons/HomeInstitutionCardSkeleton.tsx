      ...
      {Array.from({ length: 8 }).map((_, index) => (
        ...
        >
          ...
          <div className="h-24 w-full flex items-center justify-center mb-4">
            <div className="h-16 w-28 bg-muted rounded-sm" />
          </div>
          ...
          <div className="flex flex-col grow">
            ...
            <div className="space-y-2 mb-3">
              <div className="h-4 w-[85%] bg-muted rounded-sm" />
              <div className="h-4 w-[60%] bg-muted rounded-sm" />
            </div>

            {/* Location */}
            <div className="h-3 w-[40%] bg-muted rounded-sm mb-3" />

            {/* URL */}
            <div className="h-3 w-[70%] bg-muted rounded-sm mb-4" />
